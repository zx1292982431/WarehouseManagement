...
public class EmailUtil {
    private static String fromEmail = "1292982431@qq.com";  // 发件人账号
    private static String fromEmailPw = "hvqwwrrtzrgnfeef";  // 发件人密码
    ...
    public MimeMessage createMailContent(String toEmail) throws Exception, MessagingException {
        ...
        // 发件人
        message.setFrom(new InternetAddress(fromEmail, "仓库库存管理系统", "UTF-8"));
        // 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(toEmail));
        // 邮件主题
        message.setSubject("仓库库存管理系统超级管理员登录验证码", "UTF-8");
        // 邮件正文
